...
public class ShopService {
	...
	public List<Ordering> SelectByPeriod(long memberId, Date startDate, Date endDate) throws Exception{
		return orderingdao.SelectByPeriod(memberId, startDate, endDate);
	}
